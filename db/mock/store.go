...
// GsetSession mocks base method.
func (m *MockStore) GsetSession(arg0 context.Context, arg1 uuid.UUID) (db.Session, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GsetSession", arg0, arg1)
	ret0, _ := ret[0].(db.Session)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GsetSession indicates an expected call of GsetSession.
func (mr *MockStoreMockRecorder) GsetSession(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GsetSession", reflect.TypeOf((*MockStore)(nil).GsetSession), arg0, arg1)
}
